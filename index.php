<?php
    get_header();
?>
<section class="easyUsefull container-fluid">
    ...
    <section class="services container-fluid">
        ...
        <div class="container inbox selector">
            <div class="btn-title" style="color:black">
                ...
                <span class="i_caretd">
                        <i class="fas fa-caret-down inb"></i>
                    </span>
            </div>
            <div class="btn-descr box">
                <img src="<?php echo get_theme_file_uri();?>/assets/img/stat-pic.png" alt="picture" class="picture">
                <div class="textPage">
                    <span class="parag-1 container">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,</span>
                    <span class="parag-2 container">quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in </span>
        ...
        <div class="container team selector">
            <div class="btn-title" style="color:black">
                ...
                <span class="i_caretd">
                        <i class="fas fa-caret-down command"></i>
                    </span>
            </div>
            <div class="btn-descr comm">
                <img src="<?php echo get_theme_file_uri();?>/assets/img/stat-pic.png" alt="picture" class="picture">
                <div class="textPage">
                    <span class="parag-1 container">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,</span>
                    <span class="parag-2 container">quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in </span>
        ...
        <div class="container settings selector">
            <div class="btn-title" style="color:black">
                ...
                <span class="i_caretd">
                        <i class="fas fa-caret-down sett"></i>
                    </span>
            </div>
            <div class="btn-descr pref">
                <img src="<?php echo get_theme_file_uri();?>/assets/img/stat-pic.png" alt="picture" class="picture">
                <div class="textPage">
                    <span class="parag-1 container">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,</span>
                    <span class="parag-2 container">quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in </span>
        ...
        <div class="container feed selector">
            <div class="btn-title" style="color:black">
                ...
                <span class="i_caretd">
                    <i class="fas fa-caret-down fe"></i>
                </span>
            </div>
            <div class="btn-descr wifi">
                <img src="<?php echo get_theme_file_uri();?>/assets/img/stat-pic.png" alt="picture" class="picture">
                <div class="textPage">
                    <span class="parag-1 container">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,</span>
                    <span class="parag-2 container">quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in </span>
    ...
    <section class="testimonials" style="background-image: url('<?php echo get_theme_file_uri();?>/assets/img/Testimontials-bg.png');">
            ...
            <div class="slider-text">
                <div class="slider-track-text">
                    <div class="slider-item-text-1 item-text">
                        ...
                        <span class="workerDescr">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magnaLorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt </span>
                    </div>
